...
const AssistantEditorSections: React.FC<AssistantEditorSectionsProps> = ({ editor, activeAssistant }) => {
  ...
  const defaultWorkspaceMode = defaults.workspace.mode;
  const setDefaultWorkspaceMode = defaults.workspace.setMode;
  const defaultWorkspaceValue = defaults.workspace.value;
  const setDefaultWorkspaceValue = defaults.workspace.setValue;
  ...
  return (
    <div className='flex flex-col gap-16px pb-24px'>
      ...
      <DefaultsSection
        ...
        setDefaultWorkspaceMode={setDefaultWorkspaceMode}
        defaultWorkspaceValue={defaultWorkspaceValue}
        setDefaultWorkspaceValue={setDefaultWorkspaceValue}
