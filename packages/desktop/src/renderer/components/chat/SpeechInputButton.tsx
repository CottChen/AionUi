...
const SpeechInputButton: React.FC<SpeechInputButtonProps> = ({ disabled = false, onLiveTranscript, onTranscript }) => {
  ...
  useEffect(() => {
    if (disabled || !isConfigLoaded || !isSpeechToTextEnabled || availability !== 'record') {
      return;
    }
  ...
  }, [availability, disabled, isConfigLoaded, isSpeechToTextEnabled, startRecording, stopRecording]);
